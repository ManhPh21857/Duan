        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NgyaKetThuc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenSP = table.Column<string>(type: "nvarchar(300)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ma = table.Column<string>(type: "nvarchar(30)", nullable: true),
                    Ten = table.Column<string>(type: "nvarchar(30)", nullable: true),
                    TenDem = table.Column<string>(type: "nvarchar(30)", nullable: true),
                    Ho = table.Column<string>(type: "nvarchar(30)", nullable: true),
                    GioiTinh = table.Column<string>(type: "nvarchar(10)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdHang = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MaCTSP = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaGioHang = table.Column<string>(type: "nvarchar(30)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdKH = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdNV = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MaHD = table.Column<string>(type: "nvarchar(20)", nullable: true),
                    NgayTao = table.Column<DateTime>(type: "DateTime", nullable: true),
                    NgayThanhToan = table.Column<DateTime>(type: "DateTime", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaDoi = table.Column<string>(type: "nvarchar(20)", nullable: true)
                },
                constraints: table =>
                {
